...
| Light use | Monthly |
| Before major project | Always |

## Example Archive Commit Message

```
Archive: 2026-01-01 to 2026-01-14 sessions

Sessions archived:
- 2026-01-04: API integration work
- 2026-01-07: Bug fixes and testing
- 2026-01-10: Feature implementation
...
Searchable via: git log --grep="Archive:" or git log -S "keyword"
```
