  ...
  return (
    <main className="min-h-screen">
      ...
      <footer className="py-12 px-6 md:px-12 lg:px-24 border-t border-ink/10">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-muted mb-8">
          ...
          <div className="border-t border-ink/10 pt-8 text-center text-sm text-muted/70 space-y-2">
            <p>Visual content is generated using AI technology.</p>
            <p>Customer support is AI-assisted and will identify itself as such.</p>
