...
export const metadata: Metadata = {
  ...
  title: 'Hollók röpte',
  description: 'A világvége a hollók eltűnésével egyszerre érkezett. A legtöbbek persze észre sem vették a fekete madarak hiányát. Miként is várhatnánk az emberisé...',
