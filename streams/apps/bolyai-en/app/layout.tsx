...
export const metadata: Metadata = {
  ...
  description: 'For two thousand years, no one found the answer. It wasn\'t about an ancient curse, nor about a map to lost treasure — just an infinitely simple question about lines.',
  keywords: ['visual story', 'scroll-driven', 'animation', 'downstream', 'Bolyai', 'non-Euclidean geometry', 'curved space'],
  openGraph: {
    title: 'The Two-Thousand-Year Riddle: Bolyai and Curved Space',
    description: 'For two thousand years, no one found the answer. It wasn\'t about an ancient curse, nor about a map to lost treasure — just an infinitely simple question about lines.',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'The Two-Thousand-Year Riddle: Bolyai and Curved Space',
      },
    ],
  },
  twitter: {
